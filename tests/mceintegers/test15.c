...
int main(int argc, char **argv)
{
	...
	if ((y = bigIntegerFromString("3652114576131297913886519071837060826287052773555114435725",10,1)) == NULL)
		goto final;	
	/*
	if ((x = bigIntegerFromString("2387714400737643730739227671928534941685894654087032306435",10,1)) == NULL)
		goto final;
	if ((y = bigIntegerFromString("1581057822327625788018776252351063372883354299410834988425",10,1)) == NULL)
		goto final;	
