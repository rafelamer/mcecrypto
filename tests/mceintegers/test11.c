...
int main(int argc, char **argv)
{
    ...
    eq = areEqualEllipticCurvePoints(P, Q, &a, &b,ec,&error);
	freeBigInteger(a);
	freeBigInteger(b);
	printf("P and Q are equals: %d\n",eq);

	eq = areEqualEllipticCurvePoints(P, P, &a, &b,ec,&error);
	printf("P and P are equals: %d\n",eq);
